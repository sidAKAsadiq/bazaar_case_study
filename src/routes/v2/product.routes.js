...
router.post("/create_product", verify_jwt, create_product);
...
router.put("/update_product/:id", verify_jwt, update_product);
router.delete("/delete_product/:id", verify_jwt, delete_product);
